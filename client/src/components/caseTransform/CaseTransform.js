...
let options = ['Lower case', 'Upper case', 'Capitalize', 'Alternating case', 'Inverse case']
...
const CaseTransform = (props) => {
    ...
    return (
        <div className="controller" style={{borderBottom:'none'}}>
            ...
            <div className="settings_operators" style={{paddingRight: '24px', margin: '2em 0'}}>
                <div 
                    id="select_case_transform"
                ...
                <select 
                    ...
                    style={{width:'fit-content', marginLeft: '1em', backgroundColor: 'transparent', border: '1px solid #ffffff78', padding: '5px', fontWeight: '400', borderRadius: '20px', fontSize: '12px'}}
