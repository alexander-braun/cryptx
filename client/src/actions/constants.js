...
export const TOGGLE_ANALYSIS_METHOD_FQ_INPUT = 'TOGGLE_ANALYSIS_METHOD_FQ_INPUT'
export const TOGGLE_ANALYSIS_METHOD_FQ_OUTPUT = 'TOGGLE_ANALYSIS_METHOD_FQ_OUTPUT'
export const TOGGLE_ANALYSIS_METHOD_IC_INPUT = 'TOGGLE_ANALYSIS_METHOD_IC_INPUT'
export const TOGGLE_ANALYSIS_METHOD_IC_OUTPUT = 'TOGGLE_ANALYSIS_METHOD_IC_OUTPUT'
export const TOGGLE_ANALYSIS_METHOD_CHI_INPUT = 'TOGGLE_ANALYSIS_METHOD_CHI_INPUT'
export const TOGGLE_ANALYSIS_METHOD_CHI_OUTPUT = 'TOGGLE_ANALYSIS_METHOD_CHI_OUTPUT'
