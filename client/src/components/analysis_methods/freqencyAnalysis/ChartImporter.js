  ...
  <StyledTooltip
    title={
      <React.Fragment>
        ...
        language has a unique pattern of letter distribution and is identifiable
        by that pattern on a chart. Different encryption methods show
        distinguished pattern changes in the graph and make the frequency
        analysis a good tool to solve classic ciphertexts.
      </React.Fragment>
    }
  >
    <Button>
    ...
    >
      ...
      <ExpansionPanelDetails>
        ...
        <div className='freq_select' style={{ marginTop: '2em' }}>
          {panelStatus ? (
            <Fragment>
              <label htmlFor='freq_lang_select' className={classes.label}>
