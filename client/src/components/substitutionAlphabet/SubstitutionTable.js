                    ...
                    props.alphabet.split('').map(character => {
                        return (
                            <div className="substitution_wrapper" key={uuidv4()}>
                                <div className="substitution_character" key={uuidv4()}>{character.toUpperCase()}</div>
...
export default connect(mapStateToProps, mapActionsToProps)(SubstitutionAlphabet)
